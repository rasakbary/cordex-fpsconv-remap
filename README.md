...
Scripts for remapping CORDEX-FPSCONV model output onto a common regular latitude/longitude grid 
over the Greater Alpine Region — the scripts within this repository were developed on convection-permitting
models (CPMs) and their regional climate models (RCMs).
